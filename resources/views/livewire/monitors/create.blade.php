        ...
        <div class="glass rounded-2xl overflow-hidden scroll-reveal">
            <form wire:submit="save">
                <div class="p-6 space-y-6">
                    ...
                    <!-- HTTP Options -->
                    @if(in_array($type, ['http', 'https']))
                        <div class="border-t border-white/5 pt-6 scroll-reveal">
                ...
                <div class="px-6 py-4 bg-white/[0.02] border-t border-white/5 flex justify-end gap-3">
                    <a href="{{ route('monitors.index') }}" class="inline-flex items-center px-4 py-2.5 rounded-xl text-sm font-medium text-gray-300 bg-white/5 border border-white/10 hover:bg-white/10 transition-colors focus-ring" wire:navigate>
                        Cancel
                    </a>
